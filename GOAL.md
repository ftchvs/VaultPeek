...
> **Architecture:** VaultPeek is **window-first hybrid** (accepted at Gate 0 / AND-578). The principles below describe the **menu-bar glance**; the primary window workspace is the main experience for session workflows. Both surfaces share this visual system.
